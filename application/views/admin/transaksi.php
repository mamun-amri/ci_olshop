                  ...
                  <tbody>
                     ...
                     <?php foreach ($transaksi as $value) : ?>
                        <tr>
                           ...
                           <?php endif; ?>
                           <td>
                              <a class="btn btn-circle btn-sm btn-info" href="<?= base_url('snap/transaksi_detail/') . $value['id_transaksi']; ?>"><i class="fas fa-eye"></i></a>
                              <a class="btn btn-circle btn-sm btn-primary" href="<?= base_url('snap/transaksi_edit/') . $value['id_transaksi']; ?>"><i class="fas fa-edit"></i></a>
                           </td>
                        </tr>
