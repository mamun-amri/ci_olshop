...
<script>
   $(document).ready(function() {
      ...
      $('#laporan-btn-lihat').click(function() {
         ...
         var getUrlBulan = '<?= base_url('admin/AdminController/laporan_lihat_bulan/') ?>' + tahun + '/' + bulan;
         var bulanArr = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember'];
         var html = '';
         $.ajax({
            url: getUrl,
            ...
            success: function(response) {
               ...
               if (response != null) {
                  html += '' +
                     ...
                     '<a href="'+ getUrlBulan +'" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> Cetak'+
                     '</a>' +
                     '</div>';
                  html += '' +
